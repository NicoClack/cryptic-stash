...
func (_c *InviteCreate) createSpec() (*Invite, *sqlgraph.CreateSpec, error) {
	var (
	...
	if value, ok := _c.mutation.WebAuthnSession(); ok {
		vv, err := invite.ValueScanner.WebAuthnSession.Value(value)
		if err != nil {
			return nil, nil, err
		}
