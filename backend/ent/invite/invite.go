...
const (
	...
	// FieldWebAuthnSession holds the string denoting the webauthnsession field in the database.
	FieldWebAuthnSession = "web_authn_session"
...
const (
	...
	ExpiredReasonUsernameTaken ExpiredReason = "username_taken"
)
...
func ExpiredReasonValidator(er ExpiredReason) error {
	switch er {
	case ExpiredReasonRevoked, ExpiredReasonUsernameTaken:
		return nil
	default:
