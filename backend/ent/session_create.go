...
func (_c *SessionCreate) SetHashedToken(v []byte) *SessionCreate {
	_c.mutation.SetHashedToken(v)
	return _c
}
...
func (_c *SessionCreate) check() error {
	...
	if _, ok := _c.mutation.HashedToken(); !ok {
		return &ValidationError{Name: "hashedToken", err: errors.New(`ent: missing required field "Session.hashedToken"`)}
	}
	if v, ok := _c.mutation.HashedToken(); ok {
...
func (_c *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.HashedToken(); ok {
...
// SetHashedToken sets the "hashedToken" field.
func (u *SessionUpsert) SetHashedToken(v []byte) *SessionUpsert {
	u.Set(session.FieldHashedToken, v)
	return u
}

// UpdateHashedToken sets the "hashedToken" field to the value that was provided on create.
func (u *SessionUpsert) UpdateHashedToken() *SessionUpsert {
	u.SetExcluded(session.FieldHashedToken)
	return u
}
...
// SetHashedToken sets the "hashedToken" field.
func (u *SessionUpsertOne) SetHashedToken(v []byte) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetHashedToken(v)
	})
}
...
// UpdateHashedToken sets the "hashedToken" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateHashedToken() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateHashedToken()
	})
}
...
// SetHashedToken sets the "hashedToken" field.
func (u *SessionUpsertBulk) SetHashedToken(v []byte) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetHashedToken(v)
	})
}
...
// UpdateHashedToken sets the "hashedToken" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateHashedToken() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateHashedToken()
	})
}
